...
| [포트폴리오 보기 →](/portfolio/) | [개발 일지 보기 →](/devlog/) |

## 🏢 이력

| 기간                    | 이름                   | 내용                                                                                                |
| ----------------------- | ---------------------- | --------------------------------------------------------------------------------------------------- |
| 2024.05.22 ~ 2025.03.01 | 비엔에프테크놀로지(주) | 원자력 발전소 모니터링·조작 SW 개발, 운영 SW 유지보수, <br/>테스트 자동화 매크로, SRS/SDD 문서 작성 |
...
[**One Block Puzzle**](/minigames/)  
마우스로 플레이하는 간단한 미니 게임
